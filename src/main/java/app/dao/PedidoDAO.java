...
public interface PedidoDAO extends JpaRepository<Pedido, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity.produto FROM PedidoProduto entity WHERE entity.pedido.id = :id")
   ...
   */
  @Modifying
  @Query("DELETE FROM PedidoProduto entity WHERE entity.pedido.id = :instanceId AND entity.produto.id = :relationId")
