...
public interface ProdutoDAO extends JpaRepository<Produto, java.lang.String> {
  ...
  public Page<PedidoProduto> findPedidoProduto(@Param(value="id") java.lang.String id, Pageable pageable);
  /**
   * ManyToOne Relation
   * @generated
   */
  @Query("SELECT entity.pedido FROM PedidoProduto entity WHERE entity.produto.id = :id")
   ...
   */
  @Modifying
  @Query("DELETE FROM PedidoProduto entity WHERE entity.produto.id = :instanceId AND entity.pedido.id = :relationId")
